...
UserEvent.create(user: User.all[1], event: Event.first)
UserEvent.create(user: User.all[1], event: Event.first)
UserEvent.create(user: User.last, event: Event.last)
...
BusinessEvent.create(business: Business.first, event: Event.last)
BusinessEvent.create(business: Business.all[1], event: Event.first)
BusinessEvent.create(business: Business.all[1], event: Event.first)
BusinessEvent.create(business: Business.last, event: Event.last)
